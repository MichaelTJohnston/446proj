...
pGenTracking = 2*Fsun*effEoL*APanel;
...
Esci_track = 2*T*(pGenTracking - pModeSci); %[W] power used for science
Etx_track = ttx*(pGenTracking - pModeComms); % energy used in one orbit for data collection 
Egen_track = (orbits*T - 2*T - ttx) * (pGenTracking - pModeIdle); % energy generated in a day
