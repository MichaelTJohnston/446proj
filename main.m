...
P_f = Fsun*APanel*effEoL*sin(w*t); %power [W]
Egen_f = int(P_f,t,t_enter_f,t_exit_f); %energy [W.s]

%aft 
t_enter_a = T/2 %time aft panel enters light [s]
t_exit_a = T - tEclipse/2 %time aft panel exits light [s]

P_a = Fsun*APanel*effEoL*-sin(w*t); %power [W]
Egen_a =  int(P_a,t,t_enter_a,t_exit_a); %energy 

EgenBody = (Egen_f + Egen_a)*orbits;
double(EgenBody)
